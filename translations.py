...
TRANSLATIONS = {
    "es": {
        ...
        "gateway_header": "🚀 Microservicios & Herramientas Disponibles",
        "gateway_caption": "Selecciona un módulo o herramienta de analítica especializada para comenzar:",
        "service_live_analytics_title": "📈 GridFlow Live Analytics",
        "service_live_analytics_desc": "Telemetría de ERCOT en tiempo real: monitoreo nodal de precio LMP Houston Hub, mezcla de generación (Fuel Mix), demanda del sistema y actividad BESS.",
        "service_bess_intelligence_title": "🔋 BESS & Market Intelligence Hub",
        "service_bess_intelligence_desc": "Simulador financiero de arbitraje para baterías, cálculo de ROI/recaudo y modelo predictivo Machine Learning a 3-6 horas (Forecasting ERCOT).",
        "launch_btn": "⚡ Abrir Herramienta ➔",
        "nav_back_to_hub": "🏠 Hub Principal / Selector",
        "bess_hub_title": "🔋 BESS & Market Intelligence Hub | Simulación de Arbitraje & Predicción ML",
        "bess_hub_subtitle": "Optimización matemática de ciclos de carga/descarga e inteligencia predictiva a corto plazo para almacenamiento en batería",
        "bess_config_header": "⚙️ Parámetros del Sistema BESS",
        "param_capacity_mwh": "Capacidad BATERÍA (MWh)",
        "param_power_mw": "Potencia Máxima (MW)",
        "param_rte": "Eficiencia Round-Trip RTE (%)",
        "param_initial_soc": "Estado de Carga Inicial SOC (%)",
        "metric_gross_revenue": "Ingresos Brutos Estimados",
        "metric_net_profit": "Beneficio Neto Arbitraje",
        "metric_avg_spread": "Spread Promedio ($/MWh)",
        "metric_discharged_mwh": "Energía Inyectada (MWh)",
        "ml_forecast_title": "🔮 Predicción de Mercado ML (Próximas 3 a 6 Horas)",
        "ml_forecast_desc": "Modelo de regresión en series temporales para anticipación de picos de precio LMP y curva de demanda de la red ERCOT.",
        "dispatch_recommendation_title": "🎯 Recomendación Actual de Despacho BESS",
        "dispatch_charge": "🔌 CORDÓN DE CARGA (Comprar Energía Barata)",
        "dispatch_discharge": "⚡ INYECCIÓN DE DESCARGA (Vender a Precio Pico)",
    ...
    "en": {
        ...
        "gateway_header": "🚀 Available Microservices & Tools",
        "gateway_caption": "Select a specialized analytics module or tool to launch:",
        "service_live_analytics_title": "📈 GridFlow Live Analytics",
        "service_live_analytics_desc": "Real-time ERCOT telemetry: Houston Hub LMP nodal pricing, fuel generation mix, system demand, and BESS activity.",
        "service_bess_intelligence_title": "🔋 BESS & Market Intelligence Hub",
        "service_bess_intelligence_desc": "Financial battery arbitrage simulator, ROI/revenue optimizer, and 3-6h Machine Learning forecasting engine.",
        "launch_btn": "⚡ Launch Tool ➔",
        "nav_back_to_hub": "🏠 Main Hub / Gateway",
        "bess_hub_title": "🔋 BESS & Market Intelligence Hub | Arbitrage Simulation & ML Forecast",
        "bess_hub_subtitle": "Mathematical charge/discharge optimization and short-term predictive intelligence for energy storage",
        "bess_config_header": "⚙️ BESS Battery Parameters",
        "param_capacity_mwh": "Battery Capacity (MWh)",
        "param_power_mw": "Max Power (MW)",
        "param_rte": "Round-Trip Efficiency RTE (%)",
        "param_initial_soc": "Initial State of Charge SOC (%)",
        "metric_gross_revenue": "Estimated Gross Revenue",
        "metric_net_profit": "Net Arbitrage Profit",
        "metric_avg_spread": "Average Spread ($/MWh)",
        "metric_discharged_mwh": "Injected Energy (MWh)",
        "ml_forecast_title": "🔮 ML Market Forecast (Next 3 to 6 Hours)",
        "ml_forecast_desc": "Time series regression model predicting ERCOT LMP price spikes and grid load curve.",
        "dispatch_recommendation_title": "🎯 Current BESS Dispatch Recommendation",
        "dispatch_charge": "🔌 CHARGE CYCLE (Purchase Cheap Power)",
        "dispatch_discharge": "⚡ DISCHARGE INJECTION (Sell at Peak Price)",
    ...
    "fr": {
        ...
        "gateway_header": "🚀 Microservices et outils disponibles",
        "gateway_caption": "Sélectionnez un module d'analyse spécialisé à lancer :",
        "service_live_analytics_title": "📈 GridFlow Live Analytics",
        "service_live_analytics_desc": "Télémétrie ERCOT en temps réel : prix nodal Houston Hub LMP, mix de génération, demande du système et activité BESS.",
        "service_bess_intelligence_title": "🔋 BESS & Market Intelligence Hub",
        "service_bess_intelligence_desc": "Simulateur d'arbitrage financier pour batteries, optimiseur de revenus et moteur de prévision ML 3-6h.",
        "launch_btn": "⚡ Lancer l'outil ➔",
        "nav_back_to_hub": "🏠 Hub principal / Sélecteur",
        "bess_hub_title": "🔋 BESS & Market Intelligence Hub | Simulation d'Arbitrage & Prévision ML",
        "bess_hub_subtitle": "Optimisation mathématique des cycles de charge/décharge et intelligence prédictive pour le stockage d'énergie",
        "bess_config_header": "⚙️ Paramètres de la batterie BESS",
        "param_capacity_mwh": "Capacité de batterie (MWh)",
        "param_power_mw": "Puissance maximale (MW)",
        "param_rte": "Rendement aller-retour RTE (%)",
        "param_initial_soc": "État de charge initial SOC (%)",
        "metric_gross_revenue": "Revenu brut estimé",
        "metric_net_profit": "Profit net d'arbitrage",
        "metric_avg_spread": "Écart moyen ($/MWh)",
        "metric_discharged_mwh": "Énergie injectée (MWh)",
        "ml_forecast_title": "🔮 Prévision du marché ML (3 à 6 prochaines heures)",
        "ml_forecast_desc": "Modèle de régression temporelle prédisant les pics de prix LMP et la courbe de charge ERCOT.",
        "dispatch_recommendation_title": "🎯 Recommandation actuelle de répartition BESS",
        "dispatch_charge": "🔌 CYCLE DE CHARGE (Acheter de l'énergie bon marché)",
        "dispatch_discharge": "⚡ INJECTION DE DÉCHARGE (Vendre au prix le plus élevé)",
    ...
    "zh": {
        ...
        "gateway_header": "🚀 可用微服务与分析工具",
        "gateway_caption": "选择一个专用的分析模块启动：",
        "service_live_analytics_title": "📈 GridFlow Live Analytics",
        "service_live_analytics_desc": "ERCOT 实时遥测：休斯顿枢纽 LMP 节点定价、电源结构、系统需求和 BESS 电池活动。",
        "service_bess_intelligence_title": "🔋 BESS & Market Intelligence Hub",
        "service_bess_intelligence_desc": "电池套利财务模拟器、收益优化器和 3-6 小时机器学习预测引擎。",
        "launch_btn": "⚡ 启动工具 ➔",
        "nav_back_to_hub": "🏠 平台主页 / 模块选择",
        "bess_hub_title": "🔋 BESS & Market Intelligence Hub | 储能套利模拟与 ML 预测",
        "bess_hub_subtitle": "电池充放电数学优化与短期储能预测智能",
        "bess_config_header": "⚙️ BESS 电池参数配置",
        "param_capacity_mwh": "电池容量 (MWh)",
        "param_power_mw": "最大功率 (MW)",
        "param_rte": "充放电往返效率 RTE (%)",
        "param_initial_soc": "初始荷电状态 SOC (%)",
        "metric_gross_revenue": "预计总收入",
        "metric_net_profit": "净套利利润",
        "metric_avg_spread": "平均价差 ($/MWh)",
        "metric_discharged_mwh": "注入电量 (MWh)",
        "ml_forecast_title": "🔮 ML 市场预测 (未来 3 至 6 小时)",
        "ml_forecast_desc": "时间序列回归模型预测 ERCOT LMP 价格峰值和电网负荷曲线。",
        "dispatch_recommendation_title": "🎯 当前 BESS 调度建议",
        "dispatch_charge": "🔌 充电周期 (购买低价电力)",
        "dispatch_discharge": "⚡ 放电注入 (在高峰价格出售)",
    ...
    "ko": {
        ...
        "gateway_header": "🚀 사용 가능한 마이크로서비스 및 분석 도구",
        "gateway_caption": "실행할 전문 분석 모듈을 선택하십시오:",
        "service_live_analytics_title": "📈 GridFlow Live Analytics",
        "service_live_analytics_desc": "실시간 ERCOT 텔레메트리: 휴스턴 허브 LMP 노달 가격, 발전 믹스, 시스템 전력 수요 및 BESS 활동.",
        "service_bess_intelligence_title": "🔋 BESS & Market Intelligence Hub",
        "service_bess_intelligence_desc": "배터리 차익 거래 재무 시뮬레이터, 수익 최적화 엔진 및 3-6시간 ML 예측 엔진.",
        "launch_btn": "⚡ 도구 실행 ➔",
        "nav_back_to_hub": "🏠 메인 허브 / 서비스 선택",
        "bess_hub_title": "🔋 BESS & Market Intelligence Hub | 차익 거래 시뮬레이션 및 ML 예측",
        "bess_hub_subtitle": "에너지 저장을 위한 충방전 수학적 최적화 및 단기 예측 지능",
        "bess_config_header": "⚙️ BESS 배터리 파라미터",
        "param_capacity_mwh": "배터리 용량 (MWh)",
        "param_power_mw": "최대 출력 (MW)",
        "param_rte": "왕복 효율 RTE (%)",
        "param_initial_soc": "초기 충전 상태 SOC (%)",
        "metric_gross_revenue": "예상 총 수익",
        "metric_net_profit": "순 차익 이익",
        "metric_avg_spread": "평균 스프레드 ($/MWh)",
        "metric_discharged_mwh": "방전 주입 전력 (MWh)",
        "ml_forecast_title": "🔮 ML 시장 예측 (향후 3~6시간)",
        "ml_forecast_desc": "ERCOT LMP 가격 피크 및 전력망 부하 곡선을 예측하는 시계열 회귀 모델.",
        "dispatch_recommendation_title": "🎯 현재 BESS 급전 추천",
        "dispatch_charge": "🔌 충전 사이클 (저렴한 전력 구매)",
        "dispatch_discharge": "⚡ 방전 주입 (피크 가격에 판매)",
    ...
    "it": {
        ...
        "gateway_header": "🚀 Microservizi e strumenti disponibili",
        "gateway_caption": "Seleziona un modulo di analisi specializzato da avviare:",
        "service_live_analytics_title": "📈 GridFlow Live Analytics",
        "service_live_analytics_desc": "Telemetria ERCOT in tempo reale: prezzi nodali Houston Hub LMP, mix di generazione, domanda di sistema e attività BESS.",
        "service_bess_intelligence_title": "🔋 BESS & Market Intelligence Hub",
        "service_bess_intelligence_desc": "Simulatore di arbitraggio finanziario per batterie, ottimizzatore di ricavi e motore di previsione ML 3-6 ore.",
        "launch_btn": "⚡ Avvia Strumento ➔",
        "nav_back_to_hub": "🏠 Hub Principale / Selettore",
        "bess_hub_title": "🔋 BESS & Market Intelligence Hub | Simulazione Arbitraggio & Previsione ML",
        "bess_hub_subtitle": "Ottimizzazione matematica dei cicli di carica/scarica e intelligenza predittiva a breve termine",
        "bess_config_header": "⚙️ Parametri della Batteria BESS",
        "param_capacity_mwh": "Capacità Batteria (MWh)",
        "param_power_mw": "Potenza Massima (MW)",
        "param_rte": "Efficienza Round-Trip RTE (%)",
        "param_initial_soc": "Stato di Carica Iniziale SOC (%)",
        "metric_gross_revenue": "Ricavo Lordo Stimato",
        "metric_net_profit": "Profitto Netto Arbitraggio",
        "metric_avg_spread": "Spread Medio ($/MWh)",
        "metric_discharged_mwh": "Energia Iniettata (MWh)",
        "ml_forecast_title": "🔮 Previsione di Mercato ML (Prossime 3-6 Ore)",
        "ml_forecast_desc": "Modello di regressione di serie temporali per la previsione dei picchi di prezzo LMP e della curva di carico ERCOT.",
        "dispatch_recommendation_title": "🎯 Raccomandazione Attuale di Dispacciamento BESS",
        "dispatch_charge": "🔌 CICLO DI CARICA (Acquista energia a basso costo)",
        "dispatch_discharge": "⚡ INIEZIONE DI SCARICA (Vendi al prezzo di picco)",
    ...
    "pt": {
        ...
        "gateway_header": "🚀 Microsserviços e Ferramentas Disponíveis",
        "gateway_caption": "Selecione um módulo de análise especializada para iniciar:",
        "service_live_analytics_title": "📈 GridFlow Live Analytics",
        "service_live_analytics_desc": "Telemetria ERCOT em tempo real: preços nodais Houston Hub LMP, mix de geração, demanda do sistema e atividade BESS.",
        "service_bess_intelligence_title": "🔋 BESS & Market Intelligence Hub",
        "service_bess_intelligence_desc": "Simulador de arbitragem financeira para baterias, otimizador de receita e motor de previsão ML de 3-6 horas.",
        "launch_btn": "⚡ Iniciar Ferramenta ➔",
        "nav_back_to_hub": "🏠 Hub Principal / Seletor",
        "bess_hub_title": "🔋 BESS & Market Intelligence Hub | Simulação de Arbitragem e Previsão ML",
        "bess_hub_subtitle": "Otimização matemática de ciclos de carga/descarga e inteligência preditiva para armazenamento de energia",
        "bess_config_header": "⚙️ Parâmetros da Bateria BESS",
        "param_capacity_mwh": "Capacidade da Bateria (MWh)",
        "param_power_mw": "Potência Máxima (MW)",
        "param_rte": "Eficiência Round-Trip RTE (%)",
        "param_initial_soc": "Estado de Carga Inicial SOC (%)",
        "metric_gross_revenue": "Receita Bruta Estimada",
        "metric_net_profit": "Lucro Líquido de Arbitragem",
        "metric_avg_spread": "Spread Médio ($/MWh)",
        "metric_discharged_mwh": "Energia Injetada (MWh)",
        "ml_forecast_title": "🔮 Previsão de Mercado ML (Próximas 3 a 6 Horas)",
        "ml_forecast_desc": "Modelo de regressão de séries temporais prevendo picos de preço LMP e curva de carga ERCOT.",
        "dispatch_recommendation_title": "🎯 Recomendação Atual de Despacho BESS",
        "dispatch_charge": "🔌 CICLO DE CARGA (Comprar energia barata)",
        "dispatch_discharge": "⚡ INJEÇÃO DE DESCARGA (Vender no preço de pico)",
